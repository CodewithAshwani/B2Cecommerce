  ...
  if (cart) {
    ...
    for (const item of items) {
      ...
      if (existingItemIndex !== -1) {
        ...
        cart.items.push({ product: item.productId, quantity: item.quantity, Price: item.price });
      }
    }
    ...
    for (const item of items) {
      ...
      newCart.items.push({ product: item.productId, quantity: item.quantity, Price: product.Price });
    }
